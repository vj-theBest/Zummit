  ...
  return (
    <div className='flex p-12 pb-16 '>
      <div className='w-1/2'>
        ...
        <div className='w-1/2'>
            <div className='mt-6 font-extralight text-cyan-800 text-2xl'>Our Vision</div>
            <div className='m-16 ms-0 text-xl font-extralight'>An online therapy for mental health resource to empower,educate 
                ...
                <div className='float-end me-20 text-md pb-8 text-cyan-800 font-bold'><a href='#' >Know more</a></div>
        </div>
      </div>
  )
}
