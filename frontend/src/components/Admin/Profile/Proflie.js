    ...
    <div className="w-full m-10 ">
      ...
      <div className="p-4 w-[90%] rounded-md bg-white ">
        <div className="bg-[#ffffff] text-sm flex flex-col gap-5  justify-between rounded-lg w-full p-2 ">
          ...
          <input className="p-1 w-[80%] rounded-md outline-none border bg-[#FBFCFD]" type="text" value={profile.name} />
          </div>
          <div className="flex gap-20">
          <h1 className="w-[20%]">Email</h1>
          <input className="p-1 w-[80%] rounded-md outline-none border bg-[#FBFCFD]" type="text"value={profile.email} />
          </div>
          <div className="flex gap-20">
          <h1 className="w-[20%]">Mobile</h1>
          <input className="p-1 w-[80%] rounded-md outline-none border bg-[#FBFCFD]" type="text"value={profile.phone} />
          </div>
          <div className="flex gap-20">
          <h1 className="w-[20%]">Date of birth</h1>
          <input className="p-1 w-[80%] rounded-md outline-none border bg-[#FBFCFD]" type="text"value={profile.dateofBirth} />
          </div>
          <div className="flex gap-20">
          <h1 className="w-[20%]">Address</h1>
          <input className="p-1 w-[80%] rounded-md outline-none border bg-[#FBFCFD]" type="text"value={profile.address} />
          </div>
        </div>      
      </div>
    </div>
