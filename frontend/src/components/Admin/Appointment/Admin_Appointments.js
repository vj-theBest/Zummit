...
const Admin_Appointments = () => {
  return (
    <div className="w-full m-10">
      <div className="flex justify-center bg-white gap-10 items-center">
      <div className="flex items-center w-[50%] border pl-4 rounded-lg border-[#B4F0FF] ">
        <svg
          width="25"
          height="26"
          viewBox="0 0 24 25"
      ...
      <input
          type="text"
          placeholder="Search"
          className="h-12 ml-5 outline-none w-[100%]"
        />
      </div>
