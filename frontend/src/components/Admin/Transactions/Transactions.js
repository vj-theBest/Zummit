    ...
    <div className="w-full m-10 ">
      ...
      <div className="p-4 w-[90%] rounded-lg bg-white ">
        <tr className="bg-[#DCDCDD] text-lg mb-4  rounded-lg w-full p-2 text-black flex gap-2 items-center">
          <td className="w-[12rem]">Invoice Number</td>
          <td className="w-[8rem] ">Client ID</td>
        ...
        {transactions.map((item) => (
          <tr className="flex gap-2 w-full p-2 text-lg rounded-lg items-center">
            <td className="w-[13rem]">{item.invoiceNumber}</td>
            <td className="w-[9rem]">{item.clientId}</td>
            <td className="w-[12rem]">{item.clientName}</td>
            <td className="w-[10rem]">{item.doctorName}</td>
            <td className="w-[6rem] text-end ">{item.amount}</td>
            <td className="w-[8rem] text-end">{item.report}</td>
          </tr>
        ))}
      </div>
    </div>
